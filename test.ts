...
test("main", t => {
  ...
  t.is(
    normalizeUrl("http://sindresorhus.com/foo#bar:~:text=hello%20world", { stripHash: true }),
    "http://sindresorhus.com/foo",
  );
...
test("stripTextFragment option", t => {
  ...
  t.is(
    normalizeUrl("http://sindresorhus.com/about#:~:text=hello"),
    "http://sindresorhus.com/about",
  );
  t.is(normalizeUrl("http://sindresorhus.com/about#main"), "http://sindresorhus.com/about#main");
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello"),
    "http://sindresorhus.com/about#main",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello%20world"),
    "http://sindresorhus.com/about#main",
  );
  ...
  t.is(
    normalizeUrl("http://sindresorhus.com/about#:~:text=hello", options),
    "http://sindresorhus.com/about#:~:text=hello",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main", options),
    "http://sindresorhus.com/about#main",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello", options),
    "http://sindresorhus.com/about#main:~:text=hello",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello%20world", options),
  ...
  t.is(
    normalizeUrl("http://sindresorhus.com/about#:~:text=hello", options2),
    "http://sindresorhus.com/about",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main", options2),
    "http://sindresorhus.com/about",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello", options2),
    "http://sindresorhus.com/about",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/about#main:~:text=hello%20world", options2),
    "http://sindresorhus.com/about",
  );
});
...
test("removeQueryParameters option", t => {
  ...
  t.is(
    normalizeUrl("www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref", options),
    "http://www.sindresorhus.com/?foo=bar",
  );
});
...
test("removeTrailingSlash option", t => {
  ...
  t.is(normalizeUrl("http://sindresorhus.com/#/", options), "http://sindresorhus.com/#/");
  t.is(
    normalizeUrl("http://sindresorhus.com/?unicorns=true"),
    "http://sindresorhus.com/?unicorns=true",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/?unicorns=true", options),
    "http://sindresorhus.com/?unicorns=true",
  );
});
...
test("removeSingleSlash option", t => {
  ...
  t.is(normalizeUrl("https://sindresorhus.com/", options), "https://sindresorhus.com/");
  t.is(
    normalizeUrl("https://sindresorhus.com/redirect", options),
  ...
  t.is(normalizeUrl("https://sindresorhus.com/#/", options), "https://sindresorhus.com/#/");
  t.is(
    normalizeUrl("https://sindresorhus.com/?unicorns=true", options),
...
test("removeDirectoryIndex option", t => {
  ...
  t.is(
    normalizeUrl("http://sindresorhus.com/default.htm", options2),
...
test("sortQueryParameters option", t => {
  ...
  t.is(normalizeUrl("http://sindresorhus.com/", options2), "http://sindresorhus.com");
  t.is(
    normalizeUrl("http://sindresorhus.com/?a=/path", options1),
    normalizeUrl("http://sindresorhus.com/?a=/path", options2),
  );
});
...
test("remove duplicate pathname slashes", t => {
  ...
  t.is(normalizeUrl("http://sindresorhus.com//foo"), "http://sindresorhus.com/foo");
  t.is(
    normalizeUrl("http://sindresorhus.com/s3://sindresorhus.com"),
    "http://sindresorhus.com/s3://sindresorhus.com",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/s3://sindresorhus.com//foo"),
    "http://sindresorhus.com/s3://sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com//foo/s3://sindresorhus.com"),
    "http://sindresorhus.com/foo/s3://sindresorhus.com",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/git://sindresorhus.com"),
    "http://sindresorhus.com/git://sindresorhus.com",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/git://sindresorhus.com//foo"),
    "http://sindresorhus.com/git://sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com//foo/git://sindresorhus.com//foo"),
    "http://sindresorhus.com/foo/git://sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/a://sindresorhus.com//foo"),
    "http://sindresorhus.com/a:/sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl(
      "http://sindresorhus.com/alongprotocolwithin50charlimitxxxxxxxxxxxxxxxxxxxx://sindresorhus.com//foo",
    ),
    "http://sindresorhus.com/alongprotocolwithin50charlimitxxxxxxxxxxxxxxxxxxxx://sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl(
      "http://sindresorhus.com/alongprotocolexceeds50charlimitxxxxxxxxxxxxxxxxxxxxx://sindresorhus.com//foo",
    ),
    "http://sindresorhus.com/alongprotocolexceeds50charlimitxxxxxxxxxxxxxxxxxxxxx:/sindresorhus.com/foo",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/a2-.+://sindresorhus.com"),
    "http://sindresorhus.com/a2-.+://sindresorhus.com",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/a2-.+_://sindresorhus.com"),
    "http://sindresorhus.com/a2-.+_:/sindresorhus.com",
  );
  t.is(
    normalizeUrl("http://sindresorhus.com/2abc://sindresorhus.com"),
